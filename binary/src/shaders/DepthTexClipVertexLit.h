...
#include "shaders/inc/DepthTexClipVertexLit_vs30.inc"
#include "shaders/inc/DepthTexClipVertexLit_ps30.inc"
...
BEGIN_VS_SHADER(DepthTexClipVertexLit, "Help for DepthTexClipVertexLit")
...
BEGIN_SHADER_PARAMS
	...
	SHADER_PARAM(DEPTHTEXTURE, SHADER_PARAM_TYPE_TEXTURE, "sw/blood", "Multi depth texture")
...
SHADER_DRAW
{
	SHADOW_STATE
	{
		...
		DECLARE_STATIC_VERTEX_SHADER(DepthTexClipVertexLit_vs30);
		SET_STATIC_VERTEX_SHADER_COMBO(FLASHLIGHT, bHasFlashlight);
		SET_STATIC_VERTEX_SHADER(DepthTexClipVertexLit_vs30);

		DECLARE_STATIC_PIXEL_SHADER(DepthTexClipVertexLit_ps30);
		SET_STATIC_PIXEL_SHADER_COMBO(FLASHLIGHT, bHasFlashlight);
		SET_STATIC_PIXEL_SHADER(DepthTexClipVertexLit_ps30);
	...
	DYNAMIC_STATE
	{
		...
		DECLARE_DYNAMIC_VERTEX_SHADER(DepthTexClipVertexLit_vs30);
		SET_DYNAMIC_VERTEX_SHADER_COMBO(DOWATERFOG, fogIndex);
		SET_DYNAMIC_VERTEX_SHADER_COMBO(SKINNING, pShaderAPI->GetCurrentNumBones() > 0);
		SET_DYNAMIC_VERTEX_SHADER_COMBO(COMPRESSED_VERTS, (int)vertexCompression);
		SET_DYNAMIC_VERTEX_SHADER_CMD(DynamicCmdsOut, DepthTexClipVertexLit_vs30);
