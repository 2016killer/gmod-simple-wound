...
#include "shaders/inc/VertexLitInvert_vs30.inc"
#include "shaders/inc/VertexLitInvert_ps30.inc"
...
BEGIN_VS_SHADER(VertexLitInvert, "Help for VertexLitInvert")
...
SHADER_DRAW
{
	SHADOW_STATE
	{
		...
		DECLARE_STATIC_VERTEX_SHADER(VertexLitInvert_vs30);
		SET_STATIC_VERTEX_SHADER_COMBO(FLASHLIGHT, bHasFlashlight);
		SET_STATIC_VERTEX_SHADER(VertexLitInvert_vs30);

		DECLARE_STATIC_PIXEL_SHADER(VertexLitInvert_ps30);
		SET_STATIC_PIXEL_SHADER_COMBO(FLASHLIGHT, bHasFlashlight);
		SET_STATIC_PIXEL_SHADER(VertexLitInvert_ps30);
	...
	DYNAMIC_STATE
	{
		...
		DECLARE_DYNAMIC_VERTEX_SHADER(VertexLitInvert_vs30);
		SET_DYNAMIC_VERTEX_SHADER_COMBO(DOWATERFOG, fogIndex);
		SET_DYNAMIC_VERTEX_SHADER_COMBO(SKINNING, pShaderAPI->GetCurrentNumBones() > 0);
		SET_DYNAMIC_VERTEX_SHADER_COMBO(COMPRESSED_VERTS, (int)vertexCompression);
		SET_DYNAMIC_VERTEX_SHADER_CMD(DynamicCmdsOut, VertexLitInvert_vs30);
